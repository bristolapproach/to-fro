    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('private_description_template', models.TextField(blank=True, help_text='Private description will be pre-filled with this text when picking this type of help for a Job', null=True)),
                ('public_description_template', models.TextField(blank=True, help_text='Public description will be pre-filled with this text when picking this type of help for a Job', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Ward',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, help_text='Any other notes?', max_length=500, null=True)),
