    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('help_types', models.ManyToManyField(related_name='volunteer_help_types', to='categories.HelpType')),
                ...
                ('wards', models.ManyToManyField(blank=True, related_name='volunteer_wards', to='categories.Ward')),
            ],
            options={
                'abstract': False,
            },
