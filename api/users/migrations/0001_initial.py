    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_without_account', models.BooleanField(blank=True, default=False)),
                ('external_volunteer_id', models.CharField(blank=True, help_text='The ID of the volunteer in an external system', max_length=50, null=True)),
                ...
                ('time_given', models.DurationField(blank=True, null=True)),
                ...
                ('help_types', models.ManyToManyField(blank=True, related_name='volunteers', to='categories.HelpType')),
                ('requirements', models.ManyToManyField(blank=True, related_name='volunteers', to='categories.Requirement')),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='volunteer', to=settings.AUTH_USER_MODEL)),
                ('wards', models.ManyToManyField(blank=True, related_name='volunteers', to='categories.Ward')),
            ],
            options={
                'abstract': False,
            },
            bases=('users.person', models.Model),
        ),
        migrations.CreateModel(
            name='Resident',
            fields=[
                ...
                ('time_received', models.DurationField(blank=True, null=True)),
                ('ward', models.ForeignKey(help_text='The ward containing the above address.', null=True, on_delete=django.db.models.deletion.PROTECT, to='categories.Ward')),
            ],
            bases=('users.person',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('person_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='users.Person')),
                ('user_without_account', models.BooleanField(blank=True, default=False)),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='coordinator', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
