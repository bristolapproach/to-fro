...
class User(models.Model):
    ...
    email_primary = models.CharField(max_length=50, null=True, help_text="Main email for the user.")
    email_secondary = models.CharField(max_length=50, null=True, help_text="Secondary email for the user.")
