...
class User(models.Model):
    ...
    phone_number_secondary = models.CharField(max_length=15, null=True, help_text="Secondary phone number for the user.", blank=True)
    email_primary = models.CharField(max_length=50, null=True, help_text="Main email for the user.", blank=True)
    email_secondary = models.CharField(max_length=50, null=True, help_text="Secondary email for the user.", blank=True)
    notes = models.CharField(max_length=500, null=True, help_text="Any other notes?", blank=True)
    def __str__(self):
...
class Requester(User):
    user_type = models.CharField(max_length=20, null=True, default="requester", blank=True)
    address_line_1 = models.CharField(max_length=100, null=True, help_text="First line of their address.")
    address_line_2 = models.CharField(max_length=100, null=True, help_text="Second line of their address.", blank=True)
    address_line_3 = models.CharField(max_length=100, null=True, help_text="Third line of their address.", blank=True)
...
class Job(models.Model):
    ...
    helper = models.ForeignKey(Helper, on_delete=models.PROTECT, null=True, blank=True, help_text="Who will help?")
    ...
    timeTaken = models.DurationField(null=True, help_text="How long did it take to help?", blank=True)
    notes = models.TextField(max_length=500, null=True, blank=True, help_text="Any other notes?")
    public_description = models.TextField(max_length=500, null=True, blank=True, help_text="Text that gets displayed to helpers.")
    private_description = models.TextField(null=True, blank=True, help_text="Text that'll only get displayed to the helpers after they did the job")
