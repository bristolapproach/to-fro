    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('designated_coordinator', models.CharField(help_text='Who will mediate this task?', max_length=100, null=True)),
                ...
                ('timeTaken', models.DurationField(blank=True, help_text='How long did it take to complete the task?', null=True)),
