# Generated by Django 3.0.5 on 2020-04-25 19:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.ForeignKey(help_text='What was the event?', null=True, on_delete=django.db.models.deletion.PROTECT, to='core.Action')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.ForeignKey(help_text="The type of help they're happy to do.", null=True, on_delete=django.db.models.deletion.PROTECT, to='core.HelpType')),
