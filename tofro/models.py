...
class Job(models.Model):
    ...
    helper = models.ForeignKey(Requester, on_delete=models.PROTECT, null=True, help_text="Who will help?")
    job_status = models.ForeignKey(JobStatus, on_delete=models.PROTECT, null=True, help_text="What's the status of the help?")
    job_priority = models.ForeignKey(JobStatus, on_delete=models.PROTECT, null=True, help_text="What's the priority of the help?")
...
class Relationship(models.Model):
    user_1 = models.ForeignKey(User, null=True, on_delete=models.PROTECT)
    user_2 = models.ForeignKey(User, null=True, on_delete=models.PROTECT)
...
class User(models.Model):
    ...
    relationships = models.ManyToManyField(Relationship, null=True, help_text="Who has this user interacted with before?")
    jobs = models.ForeignKey(Jobs, on_delete=models.PROTECT, null=True, help_text="A list of jobs associated with this user.")
    events = models.ManyToManyField(Event, null=True, help_text="List of events generated by this user.")
    notes = models.CharField(max_length=500, null=True, help_text="Any other notes?")
...
class HelperWard(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.PROTECT, null=True, help_text="The associated user.")
...
class Helper(User):
    help_preferences = models.ManyToManyField(HelpPreference, on_delete=models.PROTECT, null=True, help_text="What the user would like to help with.")
    help_wards = models.ManyToManyField(HelpPreference, on_delete=models.PROTECT, null=True, help_text="Where the user would like to help.")
